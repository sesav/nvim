...
local function diag_toggle_buf()
  ...
  vim.notify("Buffer diagnostics " .. (enabled and "disabled" or "enabled"))
end
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          vim.keymap.set("n", "gd", function()
            builtin.lsp_definitions({ file_ignore_patterns = {} })
    ...
    dependencies = {
      -- Snippet Engine
      {
        ...
        config = function()
          ...
          luasnip.setup({})
          -- Load .snippets files (snipmate format) from the snippets/ dir in config
